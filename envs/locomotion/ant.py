...
from envs.locomotion import mujoco_goal_env

from envs.locomotion import goal_reaching_env
from envs.locomotion import maze_env
from envs.locomotion import wrappers
...
class AntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
  ...
  def __init__(self, file_path=None, expose_all_qpos=False,
               expose_body_coms=None, expose_body_comvels=None, non_zero_reset=True):
  ...
  def reset_model(self):
    ...
    if self._non_zero_reset:
      ...
      # print('Reset location is non-zero')
...
class GoalReachingAntEnv(goal_reaching_env.GoalReachingEnv, AntEnv):
  ...
  def __init__(self, goal_sampler=goal_reaching_env.disk_goal_sampler,
               file_path=None,
               expose_all_qpos=False, non_zero_reset=True, eval=False, reward_type='dense', **kwargs):
