...
@hydra.main(config_path="/u/siddhant/f-IL/f-PG/configs/samples/agents/", config_name="ppo_pointmaze.yaml")
def main(v: DictConfig):
    ...
    if v['obj'] in ['aim', 'gail', 'airl', 'fairl']:
        reward = RewardDisc(gym_env.goal_state_indices, v['env']['T'], obj=v['obj'], scale = gym_env.env.range_lim_x[1])
    elif v['obj'] == 'l2':
