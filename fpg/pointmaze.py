...
def try_evaluate(itr: int, policy_type: str, old_reward=None, reward=None, agent_density=None, rho_expert=None):
    ...
    # avg_return = evaluator.eval_goal_conditioned(3000, 300, itr)
...
if __name__ == "__main__":
    ...
    # print(sys.argv[1])
    # c = []
    # hydra.main(config_name=sys.argv[1])(lambda x:c.append(x))()
    # v = c[0]
    # v = v['configs']['samples']['agents']
    ...
    reward = Reward(gym_env.goal_state_indices, v['env']['T'], 'rkl')
    ...
    for itr in range(v['n_itrs']):
        ...
        policy.collect_data_pointmaze(v['pg']['steps_initial'], v['pg']['steps_reward_computation'])
